...
import com.example.maintenance.dto.response.*;
import com.example.maintenance.service.UserManagementService;
...
public class DashboardController {
    ...
    public ResponseEntity<MessageResponseDTO> changePassword(
        ...
        } catch (IllegalArgumentException | com.example.maintenance.exception.InvalidCredentialsException e) {
