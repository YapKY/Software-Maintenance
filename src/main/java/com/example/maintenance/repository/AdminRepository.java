...
public class AdminRepository {
    ...
    private Admin convertToAdmin(DocumentSnapshot document) {
        ...
        if (genderStr != null) admin.setGender(Gender.valueOf(genderStr));
        ...
        if (lastLoginStr != null) {
            admin.setLastLoginAt(LocalDateTime.parse(lastLoginStr));
        }
        
        admin.setCreatedAt(LocalDateTime.parse(document.getString("createdAt")));
        admin.setUpdatedAt(LocalDateTime.parse(document.getString("updatedAt")));
