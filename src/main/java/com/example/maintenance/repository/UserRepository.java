...
public class UserRepository {
    ...
    private User convertToUser(DocumentSnapshot document) {
        ...
        if (genderStr != null) user.setGender(Gender.valueOf(genderStr));

        user.setPhoneNumber(document.getString("phoneNumber"));
        user.setRole(com.example.maintenance.domain.enums.Role.valueOf(document.getString("role")));
        ...
        if (lastLoginStr != null) user.setLastLoginAt(LocalDateTime.parse(lastLoginStr));
